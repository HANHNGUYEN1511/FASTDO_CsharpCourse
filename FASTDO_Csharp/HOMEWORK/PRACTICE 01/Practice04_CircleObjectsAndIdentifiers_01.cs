...
// public class Practice04_CircleObjectsAndIdentifiers_01
// {
//     public static void Main(string[] args)
//     {
//         //Method 1: Declare variable of type Circle
//         double radius1 = 5.0;
//         double radius2 = 10.0;

//         double area1 = radius1 * radius1 * Math.PI;
//         double area2 = radius2 * radius2 * Math.PI;

//         Console.WriteLine($"Circle 1: Radius 1 = {radius1}, Area 1 = {area1}");  
//         Console.WriteLine($"Circle 2: Radius 2 = {radius2}, Area 2 = {area2}");
//     }
